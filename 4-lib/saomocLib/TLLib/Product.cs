...
namespace TLLib
{
    public class Product
    {
        ...
        public string ProductInsert(
	        ...
	        string ProductApplicant,
	        string MajorApplication
        )
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Specification", string.IsNullOrEmpty(Specification) ? dbNULL : (object)Specification);
                cmd.Parameters.AddWithValue("@ProductApplicant", string.IsNullOrEmpty(ProductApplicant) ? dbNULL : (object)ProductApplicant);
                cmd.Parameters.AddWithValue("@MajorApplication", string.IsNullOrEmpty(MajorApplication) ? dbNULL : (object)MajorApplication);
