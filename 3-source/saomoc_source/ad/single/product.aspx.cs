...
public partial class ad_single_product : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string Specification = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtSpecification")).Content.Trim()));
            string ProductApplicant = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtProductApplicant")).Content.Trim()));
            string MajorApplication = HttpUtility.HtmlDecode(FCKEditorFix.Fix(((RadEditor)row.FindControl("txtMajorApplication")).Content.Trim()));
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                if (!string.IsNullOrEmpty(ImageName))
                {
                    ...
                    ResizeCropImage.ResizeByCondition(strFullPath, 270, 181);
    ...
    protected void FileImageAlbum_FileUploaded(object sender, FileUploadedEventArgs e)
    {
        ...
        ResizeCropImage.ResizeByCondition(targetFolder + newName, 500, 500);
        ResizeCropImage.CreateThumbNailByCondition("~/res/product/album/", "~/res/product/album/thumbs/", newName, 500, 448);
