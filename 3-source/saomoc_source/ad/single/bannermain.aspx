        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Tiêu đề 1" DataField="Title1" SortExpression="Title1">
                        <ItemTemplate>
                            <%# Eval("Title1")%>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tiêu đề 2" DataField="Title2" SortExpression="Title2">
                        <ItemTemplate>
                            <%# Eval("Title2")%>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 1260px x 508px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
