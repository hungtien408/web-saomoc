        ...
        try
        {
            if (e.CommandName == "PerformInsert")
            {
                ...
                if (!string.IsNullOrEmpty(strImageName))
                {
                    ...
                    ResizeCropImage.ResizeByCondition(strFullPath, 500, 500);
                    ResizeCropImage.CreateThumbNailByCondition("~/res/product/album/", "~/res/product/album/thumbs/", strImageName, 500, 448);
                }
