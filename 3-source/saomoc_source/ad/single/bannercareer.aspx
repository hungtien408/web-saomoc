...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Tiêu đề 1" DataField="Title1" SortExpression="Title1" Visible="False">
                        <ItemTemplate>
                            <%# Eval("Title1")%>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tiêu đề 2" DataField="Title2" SortExpression="Title2" Visible="False">
                        <ItemTemplate>
                            <%# Eval("Title2")%>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn HeaderText="Thứ tự" DataField="Priority" SortExpression="Priority" Visible="False">
                        <ItemTemplate>
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 1260px x 280px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTitle1" runat="server" Text='<%# Bind("Title1") %>'
                                            Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTitle2" runat="server" Text='<%# Bind("Title2") %>'
                                            Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="AdsBannerDelete"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="7" Name="AdsCategoryID" PropertyName="SelectedValue"
                Type="String" />
